...
date: "<br> xaringan [presentation ninja] <br> 06/11/2019"
encoding: "UTF-8"
output:
...
setwd("/home/mude/data/minicurso-r-see-2019/03_dados")
```
--
```{r, eval = FALSE}
...
```{r, include = FALSE}
# ler e atribuir uma planilha eletronica (.csv) a um objeto
da <- read.csv("/home/mude/data/minicurso-r-see-2019/03_dados/ATLANTIC_AMPHIBIANS_sites.csv")
```
